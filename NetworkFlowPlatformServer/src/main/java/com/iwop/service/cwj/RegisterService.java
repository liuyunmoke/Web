...
public class RegisterService implements PPPMvcService {
	...
	public String execute(){
		Database.jdbc().update("insert into account (code,account,phone,email,password,create_time,update_time,login_time) values('111','liuyunmoke','54288','1111',now(),now())");
		return "";
	}
